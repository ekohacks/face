...
exports.getErrorResponse = exports.getGraphQLEngine = exports.getPagePathFromPageDataPath = exports.reverseFixedPagePath = exports.prepareFilesystem = exports.downloadFile = exports.TEMP_CACHE_DIR = void 0;
 ...
 */
const downloadFile = (downloadUrl, filePath) => new Promise((resolve, reject) => {
...
async function prepareFilesystem(cacheDir, siteUrl) {
    ...
    if (process_1.default.env.GATSBY_EXCLUDE_DATASTORE_FROM_BUNDLE === 'true' ||
